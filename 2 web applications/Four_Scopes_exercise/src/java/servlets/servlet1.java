...
public class servlet1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        counterSession = (counterClass) request.getSession().getAttribute("counter");
        if(counterSession == null){
            counterSession = new counterClass();
            request.getSession().setAttribute("counter", counterSession);
        }
        
        counterApplication = (counterClass) request.getServletContext().getAttribute("counter");
        if (counterApplication == null){
            counterApplication = new counterClass();
            getServletContext().setAttribute("counter", counterApplication);
        }
